...
const Activities = () => {
    return (
        <div style={{ padding: '5rem 2rem', maxWidth: '1200px', margin: '0 auto' }}>
            <h1 style={{ textAlign: 'center', color: 'var(--color-primary)', marginBottom: '3rem' }}>Activities & Shows</h1>
            ...
            <div style={{
                ...
                {activities.map(item => (
                    <Link key={item.id} to={`/detail/activities/${item.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                        <div style={{
